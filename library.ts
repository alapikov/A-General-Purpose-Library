...
function searchItemLinear(input: (string | number)[], item: string | number) {
...
function searchItemBinary(input: number[], item: number) {
	let copy = [...input];
	let arrStart = 0;
...
function formatPhonenum(input: number) {
